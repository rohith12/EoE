...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        if (userId != nil){
            ...
            let main = storyboard.instantiateViewController(withIdentifier: "tab") as! tabBarViewController
...
//    }
    ...
    func handleLocalNotification(_ not: UILocalNotification,app: UIApplication){
    ...
    lazy var applicationDocumentsDirectory: URL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "CU._a_EOE" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle.main.url(forResource: "_a_EOE", withExtension: "momd")!
